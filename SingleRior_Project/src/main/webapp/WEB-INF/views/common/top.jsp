	...
	<header class="py-1 bg-white border-bottom">
		<div class="container d-flex flex-wrap justify-content-center fs-5">
			<ul class="nav me-auto">
				<li class="nav-item">
					<button class="navbar-toggler px-3" style="padding-top: 13px;" type="button" data-bs-toggle="collapse" data-bs-target="#navbarHeader" aria-controls="navbarHeader" aria-expanded="false" aria-label="Toggle navigation">
						<img src="https://www.flaticon.com/svg/vstatic/svg/3917/3917139.svg?token=exp=1670488277~hmac=8fc26b4572c68325f57cab96a22bfb10" style="margin-right: 8px;" width="16" height="16">
	        			카테고리
					</button>
	        	</li>
