					...
					<form class="needs-validation"
						...
						<div class="row g-3">
							...
							<div class="col-12">
								...
								<label> 카테고리 </label>
								<input type="text" class="form-control" id="boardCategory" name="boardTitle" readonly>
								<label for="boardTitle" class="form-label">제목</label> 
								<input type="text" class="form-control" id="boardTitle" name="boardTitle" readonly>
							</div>

							<div class="col-12">
								<label for="boardContent" class="form-label">내용</label>
								<div class="input-group">
									<textarea class="form-control" rows="10" name="boardContent" style="resize: none;" readonly></textarea>
								</div>
							</div>
